...
_Developing a physical model of [theory of thalamo-cortical function](https://sites.google.com/site/pablomayrgundter/mind) with [PBC's PSI AI assistant](https://github.com/psi-oss/get-physics-done)._
